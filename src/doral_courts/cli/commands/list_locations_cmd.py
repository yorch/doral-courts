"""List locations command implementation."""
...
from ...display.lists import display_locations_list
...
@click.command(name="list-locations")
@click.option(
    "--sport",
...
def list_locations(
    ...
    courts, _ = fetch_and_store(ctx, parsed_date, sport=sport, suffix="_list_locations")
    if not courts:
        return
