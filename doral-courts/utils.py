...
def display_locations_list(courts: List[Court], sport_filter: Optional[str] = None):
    ...
    console.print(f"[cyan]Total: {total_locations} locations with {total_courts} courts[/cyan]\n")
    ...
    # Add helpful footer
    console.print(f"\n[dim]💡 Tip: Use location names with other commands to filter results[/dim]")
